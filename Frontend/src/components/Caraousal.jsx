...
//     {
//       title: "Easy to Use",
//       content: "We've used Polify for a range of activities from training quizzes to customer surveys. The tool is versatile and efficient, making it easy to gather and analyze responses.",
//       name: "Aman Vats",
...
//   const cardWidth = useBreakpointValue({ base: '85vw', sm: '70vw', md: '50vw', lg: '400px' });
...
//       const newTranslateX = -(currentIndex * (parseFloat(cardWidth) + cardSpacing));
...
//               <Text fontSize={titleFontSize} fontWeight="bold" color="teal.500">
//                 "{card.title}"
//               </Text>
...
//                   <Text fontWeight="bold" fontSize={fontSize}>{card.name}</Text>
